...
# Leads score tells us how likely a lead is to make a purchase
...
## 1.1.1 Rank Leads from Best to Worst
#(1. assign rank number to each lead per lead_score)
# 2. calculate gain (cumulative sum of purchases per lead)
...
# Threshold selection: using 95% confidence interval
thresh = 0.95
...
# confusion matrix is a tool used to measure the performance of a machine learning model
...
# 4.2 Expected Monthly Value (Unrealized because of delayed nurture effect)
