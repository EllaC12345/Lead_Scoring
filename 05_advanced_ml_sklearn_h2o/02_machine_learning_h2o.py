...
x_cols = [#'mailchimp_id', 'user_full_name', 'user_email', 
          'member_rating', 
          #'optin_time', 
...
# leaderboard shows the best model to get 
aml.leaderboard
...
model_h2o_stacked_ensemble = h2o.get_model(
    model_id = 'StackedEnsemble_AllModels_3_AutoML_1_20240509_104305'
)
...
## You have to run the model on its current H2o version
h2o.__version__ 
